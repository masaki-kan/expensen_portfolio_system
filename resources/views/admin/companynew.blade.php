        ...
        <form action="{{ route('company_input') }}" method="POST" class="row">
            ...
            <div class="col-sm-8 col-sm-offset-2 mt-5" style="margin-top:40px;">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="zip" name="zip" class="form-control" placeholder="例：111-0000" value="{{ old('zip') }}">
                </div>
                @if( $errors->has('zip') )
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="zip" name="address" class="form-control" placeholder="例：東京都目黒区..1丁目1-1" value="{{ old('adress') }}">
                </div>
